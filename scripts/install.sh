#!/bin/sh
# GoLinx installer for Linux and macOS.
# Usage:  curl -fsSL https://raw.githubusercontent.com/staceyw/GoLinx/main/scripts/install.sh | bash
set -e
...
BINARY="golinx-${OS}-${ARCH}"

# --- Pre-flight checks ----------------------------------------------------

echo ""
echo "GoLinx Installer"
echo "================"
echo ""
...
echo ""
echo "Quick start:"
echo '  1) ./golinx --listen "http://:80"'
echo "  2) Click the URL in the terminal or open http://localhost in your browser."
echo ""
echo "For persistent config, copy golinx.example.toml to golinx.toml and run ./golinx with no flags."
echo ""
